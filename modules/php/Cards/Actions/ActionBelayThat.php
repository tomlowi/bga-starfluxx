...
class ActionBelayThat extends ActionCard
{
  public function __construct($cardId, $uniqueId)
  {
    ...
    $this->help = clienttranslate(
      "Select any Action card to discard from your hand, or select nothing and get a random card discarded."
    );
  }
  ...
  {
    // if a card was selected, validate it is an Action card in hand of player and discard
    ...
    if ($card != null && (
      ...
      Utils::throwInvalidUserAction(
        starfluxx::totranslate(
          "You must discard an Action card from your hand"
        )
      );
    }
